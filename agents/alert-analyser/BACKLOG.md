...
| 8 | Wire up incident_purge_days / incident_purge_enabled | 1–1.5 hrs | Config keys exist and are read but never acted on — no scheduled purge job for alert_reports table; dead setting | 8 | TBD | 1.5 | Open |
