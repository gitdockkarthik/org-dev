...
class PostgresBackend(StorageBackend):
    ...
    def _row_to_dict(row) -> dict:
        ...
        return {
            ...
            "schema_registry_username": row.schema_registry_username or None,
            "schema_registry_password": row.schema_registry_password or None,
            "sr_restricted": row.sr_restricted,
